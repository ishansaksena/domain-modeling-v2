...
class FamilyTests : XCTestCase {
    ...
    func testFamily() {
        ...
        print("")
        print("The family income is: \(familyIncome)")
        print("")
    ...
    func testDescription() {
        ...
        XCTAssert(family.description == "The Neward family has Ted and Charlotte. ")
        ...
        family.haveChild(matt)
        XCTAssert(family.description == "The Neward family has Ted and Charlotte. " +
                                        "Their child no. 1 is Mike" +
                                        "Their child no. 2 is Matt")
    }
